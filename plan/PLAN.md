...
- **Done:** Steps 1–4; Home page, **Services** page, **Contact** page, **Work** page, **About** page, **Industries** page, **Careers** page, and **Insights** page built with shared components (single-column stack, Header, Footer, design tokens). Contact booking CTA configured with a Calendly link. Header now highlights active page.
- **Next:** Build remaining pages in this order: **Legal** → 404. Each page must use the same design (see `COMPONENTS.md` and `NEXT_STEPS.md`).
